...
- [`services.ocis`](#opt-services.ocis.enable) now supports the blessed Owncloud Infinite Scale upgrade path. See the [oCIS section of the NixOS manual](#module-services-ocis) for more information.
