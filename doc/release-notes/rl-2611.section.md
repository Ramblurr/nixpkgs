...
- Added `ocis_70-bin`, `ocis_71-bin`, `ocis_72-bin`, `ocis_73-bin`,
  `ocis_80-bin`, and `ocis_81-bin` to provide every required production
  release in the ownCloud Infinite Scale upgrade path from 5.0.x to 8.1.x.
